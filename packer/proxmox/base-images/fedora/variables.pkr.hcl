variable "fedora_version" {
  type        = string
  description = "The Fedora major version being built (e.g. '43')"
}
...
variable "packages" {
  type        = list(string)
  description = "A list of packages to install during cloud-init"
  default     = []
}

variable "repo_mirror" {
  type        = string
  description = "Optional repository mirror URL. Leave empty to use the default."
  default     = ""
}
